...
public class NavigationAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean b,
		...
		TextView subTitleView = (TextView) layout
	...
	public View getGroupView(int i, boolean isExpanded, View view,
		...
		ImageView indicator = (ImageView) layout
		...
		if (getChildrenCount(i) == 0) {
			...
			indicator.setImageResource(isExpanded ? R.drawable.arrowhead_up
					: R.drawable.arrowhead_down);
		}

		if (i == 0) {
			indicator.setVisibility(View.VISIBLE);
			indicator.setImageResource(R.drawable.ic_action_select_all);
		}

		if (i == 1) {
			indicator.setVisibility(View.VISIBLE);
			indicator.setImageResource(R.drawable.ic_action_download);
		}

		if (i == 2) {
			indicator.setVisibility(View.VISIBLE);
			indicator.setImageResource(R.drawable.ic_action_view_as_list);
		}
