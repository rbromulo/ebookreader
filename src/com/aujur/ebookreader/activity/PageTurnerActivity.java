...
/**
 * Created with IntelliJ IDEA. User: alex Date: 7/14/13 Time: 10:14 AM To change
...
public abstract class PageTurnerActivity extends RoboSherlockFragmentActivity
	...
	protected final void onCreate(Bundle savedInstanceState) {
		...
		mToggle = new ActionBarDrawerToggleCompat(this, mDrawer,
	...
	protected String[] getMenuItems(Configuration config) {
		...
		if (new File(config.getLastOpenedFile()).exists()) {
			...
			return array(getString(R.string.open_library),
					getString(R.string.download), config.getLastReadTitle());
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		initDrawerItems(mDrawerOptions);
		return super.onPrepareOptionsMenu(menu); // To change body of overridden
													// methods use File |
													// Settings | File
													// Templates.
	}
