...
import com.aujur.ebookreader.dto.PageOffsets;
...
public class Configuration {
	...
	// public static final String BASE_OPDS_FEED =
	// "http://www.auxiliojuridico.com/AuJurCatalogoWeb/vademecum/catalogo.xml";
	public static final String BASE_OPDS_FEED = "vademecum/catalogo.xml";
	...
	public int getTheme() {
		if (getColourProfile() == ColourProfile.NIGHT) {
			...
			return R.style.Theme_Aujurtheme;
		}
	...
	public static double getMemoryUsage() {
		/*
		 * Runtime runtime = Runtime.getRuntime(); long maxHeapMemoryBytes =
		 * runtime.maxMemory(); long allocatedMemoryBytes =
		 * runtime.totalMemory() - runtime.freeMemory(); return (double)
		 * allocatedMemoryBytes / (double) maxHeapMemoryBytes;
		 */
